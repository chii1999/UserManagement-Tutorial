  ...
  return (
    <motion.div
      ...
      <div className="border rounded-md p-4 bg-white">
        <header className="py-2 px-4 rounded-sm mb-2">
          <h3 className="text-xl font-medium text-gray-500">
            ຟອມສ້າງບັນຊີນຳໃຊ້ Software Manger
          </h3>
        </header>
        <Divider className="mb-6" />
        <form onSubmit={addUserData} className="flex flex-col gap-4 pt-6">
          <h1 className="mx-6 px-2 py-2 border-l-2 border-l-sky-500 bg-sky-200 font-medium text-gray-500">
            ຂໍ້ມູນນຳໃຊ້ລະບົບ Manager
          </h1>
          ...
          <h1 className="mx-6 mt-6 px-2 py-2 border-l-2 border-l-sky-500 bg-sky-200 font-medium text-gray-500">
            ຂໍ້ມູນໂປຣໄຟຣຂອງ user ນັ້ນ
          </h1>
          ...
          <Divider />
          {/* <div className="py-2 mx-6 mt-2 h-auto flex flex-col justify-center gap-4 items-center rounded-md">
            {!isimage && (
              <Avatar
                alt="Pic"
                src={file}
                className="w-full h-full object-cover bg-white shadow-md"
            ...
            <div>
              <label
                htmlFor="fileName"
                className="py-1 px-8 rounded-sm shadow-md group flex flex-col justify-center items-center hover:bg-sky-500 bg-sky-400 text-white cursor-pointer">
                <CloudUploadIcon
                  sx={{ fontSize: 20 }}
